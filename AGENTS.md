...
Preserve the project boundaries and established patterns. Read risky areas before sensitive work, run the relevant checks, never expose secrets, and update AI context when indexed behavior changes.
